...
insert into mascota(mas_nombre,mas_tipo,mas_raza,mas_peso,mas_sexo,mas_tamano,mas_des_social,mas_edad,mas_dueno) values('Princesa','Perro','Baset hound',12,'h',32,'Perezoso',3.25,7);
...
insert into mascota(mas_nombre,mas_tipo,mas_raza,mas_peso,mas_sexo,mas_tamano,mas_des_social,mas_edad,mas_dueno) values('Niña','Perro','Criollo',17,'h',32,'Juguetón',3,9);
